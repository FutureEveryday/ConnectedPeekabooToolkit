...
const char* OOCSIName = "sensormodule2";
...
void loop() {
  ...
  // add data here
  oocsi.addFloat("sensorvalue3", 10 + 7 * sin(millis()));

  // add data here
  oocsi.addFloat("sensorvalue4", 40 + 25 * sin(millis()));

  // add data here
  oocsi.addFloat("sensorvalue5", 12 + 10 * cos(millis()));
